...
export const Specialist = () => {
    return (
        <>
                    {/* Hero section */}
        <section>
                <div className="container-fluid hero-specialized">

                    <div className="col-md-6 hero-content-specialized                     animate__animated animate__fadeInLeft">
                                <h1 className="font-weight-bold text-white">Added essential services for your traveler’s convenience<span style={{color:"#0275d8"}}> </span></h1>
