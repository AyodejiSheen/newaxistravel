        ...
        <section>
                <div className="container-fluid hero-corporate">
                    ...
                    <div className="col-md-6 hero-content-corporate animate__animated animate__fadeInLeft">
                                ...
                                <p className="text-white heading-note text-justify">Whether it’s exploring new wonders in places beyond or taking trips to bring your business to grander heights, Axis Travel & Tourism offers first-rate travel and tour solutions to make each journey a worry-free experience. From booking flight tickets and accommodation to organizing leisure tours.</p>
...
<section>
    <div className="container-fluid">
            <div className="row">
                ...
                <img src={trip} className="img-fluid" loading="lazy"/>
                </div>

                <div className="col-md-5 p-5 order-1 order-md-2 column-note">
                <h1 className="head-tag text-left adjust-head" >When we plan your business trips,  <span style={{color:'#0275d8'}}>we mean business.</span> </h1>
                <p className="text-justify heading-note adjust-note">We understand that business travel is a big deal for global organizations so we take yours seriously. Our focus is to make your business trips as smooth as possible with zero time wasted on the unnecessary back and forth.</p>  
...
<section className="priemer-section pb-4">
        <div className="container-fluid priemer p-0">
            <div className="">
        ...
        <div className="container-fluid">
            <div className="row">
                <div data-aos="fade-up" className="col-md-7 p-0 order-2 order-md-1">
                    <img src={unique} className="qualities-pics img-fluid" loading="lazy"/>
                </div>

                <div className="col-md-5 corporate-list p-5 order-1 order-md-2">
                <h1 className="head-tag text-left adjust-head">Unique travel solutions  <span style={{color:'#0275d8'}}>designed for your company </span></h1>
                <p className="text-justify heading-note adjust-note">Whatever the business activity, whether setting goals or travelling, your company does it differently. From the frequency of travel, the number of travelers, travelling budget, time frame, frequently visited countries and so on, your company is unique and special to us.</p>
                <p className="text-justify heading-note adjust-note">As an industry giant or a dignified SME, enjoy customized travel solutions that resonate with your company’s style and preference.</p>
                </div>
            </div>
        </div>
</section>
...
<section className="mt-5 pb-5">
        ...
        <h1 className="head-tag text-center mb-0">Key Features of our  <span style={{color:'#0275d8'}}>Corporate Travel solutions</span></h1>
            ...
            <div className="row mt-4 ">
                <div className="col-md-4">
                        ...
                        <div className="card-body ">
                            <h3 className="card-title tour-title " style={{fontWeight:'bold'}}>Financial visibility for your business</h3>
                ...
                <div className="col-md-4">
                <div className="card border-0  corporate-feature">
                        <img src={simpler} class="card-img-top img-fluid card-image rounded-0" loading="lazy"/>
                        <div className="card-body ">
                            <h3 className="card-title tour-title " style={{fontWeight:'bold'}}>Simpler business travel for your people</h3>
                ...
                <div className="col-md-4">
                <div className="card border-0  corporate-feature">
                        <img src={industry} class="card-img-top img-fluid card-image rounded-0 " loading="lazy"/>
                        <div className="card-body ">
                            <h3 className="card-title tour-title " style={{fontWeight:'bold'}}>We have advanced industry insight</h3>
            ...
            <div className="row mt-5">
                <div className="col-md-4">
                <div className="card border-0  corporate-feature">
                        <img src={policy} class="card-img-top img-fluid card-image rounded-0" style={{height:"200px"}} loading="lazy"/>
                        <div className="card-body ">
                            <h3 className="card-title tour-title " style={{fontWeight:'bold'}}>We adhere strongly to your company travel policy</h3>
